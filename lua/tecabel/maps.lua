...
keymap.set('n', '<leader>:', '<cmd>Telescope commands<cr>', opts)
keymap.set('n', '<leader>n', '<cmd>Telescope file_browser path=%:p:h select_buffer=true initial_mode=normal<cr>', opts)
